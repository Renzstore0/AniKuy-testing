...
export default function GenrePage() {
  useEffect(() => {
    document.body.setAttribute("data-page", "genre");
      ...
      <div className="app-root">
        ...
        <main id="mainContent">
          <div className="page-container">
            <h2 id="genreTitle" className="page-title">
              Genre
            </h2>
            ...
            <div className="pagination-bar">
              ...
              <span id="genrePageInfo" className="page-info">
                Page 1 / 1
              </span>
              <button id="genreNextBtn" className="btn-outline" type="button">
                Next
              </button>
            </div>

            <div id="genreAnimeGrid" className="anime-grid full-grid" />
          </div>
        </main>
