...
export default function DetailAnimePage() {
  useEffect(() => {
    document.body.setAttribute("data-page", "detail");
      ...
      <div className="app-root">
        ...
        <main id="mainContent">
          <div className="page-container">
            <div id="animeDetailContent" className="anime-detail" />

            <div className="section-header section-header-episodes">
              <div className="episode-tabs">
                <button
                  type="button"
                  id="tabEpisodes"
                  className="episode-tab active"
                >
                  Episode
                </button>
                <button
            ...
            <div id="seasonList" className="episode-list season-list" />

            <h3 className="section-title small-title">Rekomendasi</h3>
            <div id="recommendationGrid" className="anime-row" />
          </div>
        </main>
