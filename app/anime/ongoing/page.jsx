...
export default function OngoingAnimePage() {
  useEffect(() => {
    document.body.setAttribute("data-page", "ongoing");
  ...
  return (
    <>
        ...
        <main id="mainContent">
          <div className="page-container">
            ...
            <div className="pagination-bar">
              ...
              <button id="ongoingNextBtn" className="btn-outline" type="button">
                Next
              </button>
            </div>

            <div id="ongoingGridFull" className="anime-grid full-grid" />
          </div>
        </main>
      ...
      <Script src="/assets/js/ongoing.js" />
    </>
  );
}