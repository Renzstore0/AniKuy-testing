...
export default function MyListPage() {
  useEffect(() => {
    document.body.setAttribute("data-page", "my-list");
    ...
    <>
      <div className="app-root">
        ...
        <main id="mainContent">
          <div className="page-container">
            ...
            <div
              ...
              style={{ marginTop: "32vh", textAlign: "center" }}
            >
              Belum ada anime di favorit.
            </div>

            <div id="myListGrid" className="anime-grid full-grid" />
          </div>
        </main>
        ...
        <nav className="bottom-nav">
          ...
          <a className="nav-item active" data-tab="my-list" href="/my-list">
            <svg className="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fill="currentColor"
      ...
      <Script src="/assets/js/my-list.js" />
    </>
  );
}