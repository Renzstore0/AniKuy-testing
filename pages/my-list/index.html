...
export default function MyListPage() {
  useEffect(() => {
    document.body.dataset.page = "my-list";
    return () => {
  ...
  return (
    <>
      <Head>
        <meta charSet="UTF-8" />
        <title>AniKuy - My List</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />

        <meta
          name="description"
          content="My List AniKuy: tempat nyimpen semua anime favoritmu. Tambahkan, kelola, dan pantau progres tontonanmu dalam satu halaman yang rapi."
        />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="AniKuy" />
        <meta property="og:title" content="My List - AniKuy" />
        <meta
          property="og:description"
          content="My List AniKuy: tempat nyimpen semua anime favoritmu. Tambahkan, kelola, dan pantau progres tontonanmu dalam satu halaman yang rapi."
        />
        <meta property="og:url" content="https://anikuy.my.id/my-list" />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="My List - AniKuy" />
        <meta
        ...
        <main id="mainContent">
          <div className="page-container">
            ...
            <div
              ...
              style={{ marginTop: 8 }}
            >
              Belum ada anime di favorit.
            </div>

            <div id="myListGrid" className="anime-grid full-grid"></div>
          </div>
        </main>
      ...
      <Script src="/assets/js/my-list.js" strategy="afterInteractive" />
    </>
  );
}
