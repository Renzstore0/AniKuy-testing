...
export default function AnimeOngoingPage() {
  useEffect(() => {
    document.body.dataset.page = "ongoing";
    return () => {
  ...
  return (
    <>
      <Head>
        <meta charSet="UTF-8" />
        <title>AniKuy - Sedang Tayang</title>
      ...
      <div className="app-root">
        ...
        <main id="mainContent">
          <div className="page-container">
            <h2 className="page-title">Sedang Tayang</h2>
            ...
            <div className="pagination-bar">
              ...
              <span id="ongoingPageInfo" className="page-info">
                Page 1 / 1
              </span>
              <button
                id="ongoingNextBtn"
            ...
            <div id="ongoingGridFull" className="anime-grid full-grid"></div>
          </div>
        </main>
      ...
      <Script src="/assets/js/ongoing.js" strategy="afterInteractive" />
    </>
  );
}
