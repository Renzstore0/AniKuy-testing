...
export default function AnimeEpisodePage() {
  useEffect(() => {
    document.body.dataset.page = "episode";
    return () => {
  ...
  return (
    <>
      ...
      <div className="app-root">
        ...
        <main id="mainContent">
          <div className="page-container">
            ...
            {/* TOOLBAR: SERVER / QUALITY / DOWNLOAD / SHARE */}
            ...
            <div id="playerDropdownContainer" className="dropdown-container">
              <div id="serverMenu" className="dropdown-panel"></div>
              <div id="qualityMenu" className="dropdown-panel"></div>
              <div id="downloadMenu" className="dropdown-panel"></div>
            </div>
      ...
      <Script src="/assets/js/episode.js" strategy="afterInteractive" />
    </>
  );
}
