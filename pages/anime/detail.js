...
export default function AnimeDetailPage() {
  ...
  return (
    <>
      <Head>
        <meta charSet="UTF-8" />
        <title>AniKuy - Detail Anime</title>
      ...
      <div className="app-root">
        ...
        <main id="mainContent">
          <div className="page-container">
            {/* detail poster + meta */}
            <div id="animeDetailContent" className="anime-detail"></div>

            {/* list episode */}
            <h3 className="section-title small-title">Episode</h3>
            <div id="episodeList" className="episode-list"></div>

            {/* rekomendasi horizontal scroll */}
            <h3 className="section-title small-title">Rekomendasi</h3>
            <div id="recommendationGrid" className="anime-row"></div>
          </div>
        </main>
      ...
      <Script src="/assets/js/detail.js" strategy="afterInteractive" />
    </>
  );
}
