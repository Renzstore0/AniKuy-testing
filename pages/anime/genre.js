...
export default function AnimeGenrePage() {
  useEffect(() => {
    document.body.dataset.page = "genre";
    return () => {
  ...
  return (
    <>
      ...
      <div className="app-root">
        ...
        <main id="mainContent">
          <div className="page-container">
            ...
            <div
              id="genreAnimeGrid"
              className="anime-grid full-grid"
            ></div>
          </div>
        </main>
      ...
      <Script src="/assets/js/genre.js" strategy="afterInteractive" />
    </>
  );
}
