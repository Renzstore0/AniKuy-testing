...
export default function AnimeCompletePage() {
  useEffect(() => {
    document.body.dataset.page = "complete";
    return () => {
  ...
  return (
    <>
      <Head>
        <meta charSet="UTF-8" />
        <title>AniKuy - Selesai Ditayangkan</title>
      ...
      <div className="app-root">
        ...
        <main id="mainContent">
          <div className="page-container">
            <h2 className="page-title">Selesai Ditayangkan</h2>
            ...
            <div className="pagination-bar">
              ...
              <span id="completePageInfo" className="page-info">
                Page 1 / 1
              </span>
              <button
                id="completeNextBtn"
            ...
            <div id="completeGridFull" className="anime-grid full-grid"></div>
          </div>
        </main>
      ...
      <Script src="/assets/js/complete.js" strategy="afterInteractive" />
    </>
  );
}
